...
const Job = ({ job }) => {
  ...
  return (
    <div className="p-5 rounded-md shadow-xl dark:bg-gray-900 bg-white border dark:border-gray-600 border-gray-100 overflow-hidden transition-transform transform hover:scale-105 duration-300">
